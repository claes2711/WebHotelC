...
namespace WebHotel.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,RoomID,Email,CheckIn,CheckOut,Cost")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Search([Bind("CheckIn,CheckOut,BedCount")] Booking booking)
        {
            if (ModelState.IsValid)
            {
                _context.Add(booking);
